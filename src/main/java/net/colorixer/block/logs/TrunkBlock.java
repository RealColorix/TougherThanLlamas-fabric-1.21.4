...
public class TrunkBlock extends Block {
    ...
    private static final VoxelShape Y_AXIS_SHAPE = VoxelShapes.cuboid(0.125, 0.0, 0.125, 0.875, 1.0, 0.875);
    private static final VoxelShape X_AXIS_SHAPE = VoxelShapes.cuboid(0.0, 0.125, 0.125, 1.0, 0.875, 0.875);
    private static final VoxelShape Z_AXIS_SHAPE = VoxelShapes.cuboid(0.125, 0.125, 0.0, 0.875, 0.875, 1.0);
