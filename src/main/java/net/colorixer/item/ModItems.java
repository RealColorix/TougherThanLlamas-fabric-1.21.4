...
public class ModItems {
    ...
    public static final Item FIRE_PLOUGH = registerItem("fire_plough", settings -> new FireStarterItem(settings, 0.01), new Item.Settings().maxCount(1).maxDamage(200));
    public static final Item BOW_DRILL = registerItem("bow_drill", settings -> new FireStarterItem(settings, 0.05), new Item.Settings().maxCount(1).maxDamage(500));
