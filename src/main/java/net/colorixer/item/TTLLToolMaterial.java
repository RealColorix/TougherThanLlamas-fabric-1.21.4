...
public class TTLLToolMaterial {
    ...
    public static final ToolMaterial FLINT_FOR_AXE = new ToolMaterial(
            BlockTags.INCORRECT_FOR_WOODEN_TOOL, 7,2.0F,  0.0F, 8, ItemTags.WOODEN_TOOL_MATERIALS);
    public static final ToolMaterial FLINT_TWINE_FOR_AXE = new ToolMaterial(
            BlockTags.INCORRECT_FOR_WOODEN_TOOL, 29,2.0F,  0.0F, 8, ItemTags.WOODEN_TOOL_MATERIALS);
    public static final ToolMaterial FLINT_STRING_FOR_AXE = new ToolMaterial(
            BlockTags.INCORRECT_FOR_WOODEN_TOOL, 53,2.0F,  0.0F, 8, ItemTags.WOODEN_TOOL_MATERIALS);
    public static final ToolMaterial FLINT_LEATHER_GRIP_FOR_AXE = new ToolMaterial(
            BlockTags.INCORRECT_FOR_WOODEN_TOOL, 10,2.5F,  0.0F, 8, ItemTags.WOODEN_TOOL_MATERIALS);
    public static final ToolMaterial FLINT_TWINE_LEATHER_GRIP_FOR_AXE = new ToolMaterial(
            BlockTags.INCORRECT_FOR_WOODEN_TOOL, 35,2.5F,  0.0F, 8, ItemTags.WOODEN_TOOL_MATERIALS);
    public static final ToolMaterial FLINT_STRING_LEATHER_GRIP_FOR_AXE = new ToolMaterial(
            BlockTags.INCORRECT_FOR_WOODEN_TOOL, 60,2.5F,  0.0F, 8, ItemTags.WOODEN_TOOL_MATERIALS);
